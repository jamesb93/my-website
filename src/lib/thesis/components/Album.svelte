<script>
    ...
    import { durations } from '$lib/thesis/stores.js';
    import Container from '$lib/thesis/components/Container.svelte';
    import Button from '$lib/thesis/components/Button.svelte';
    import { cloudPrefix, noext } from '$lib/thesis/utility/paths.js';
